FONTS = """extern const uint8_t u8g2_font_u8glib_4_tf[] U8G2_FONT_SECTION("u8g2_font_u8glib_4_tf");
...
for line in FONTS.split('\n'):
    try:
        ...
        if font[-2:] == 'tf':
            #print(font)    
            allTFfonts.append(font)
    except:
        pass

#print( len(allTFfonts) )

for font in allTFfonts:
    print('  { "' + font + '", ' + font + ' },' )