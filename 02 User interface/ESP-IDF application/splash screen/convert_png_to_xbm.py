...
INPUT_PATH = r"C:\Users\henkj\Documents\GitHub\BedClock\02 User interface\ESP-IDF application\splash screen"
...
def convert_png_to_xbm(index, file_name):
    ...
    with Image.open(os.path.join(INPUT_PATH,file_name)) as img:
        ...
        single_header_file.append(f"static const uint8_t {bytes_name}[] = " + "{")
