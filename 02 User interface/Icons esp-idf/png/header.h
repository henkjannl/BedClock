...
uint8_t test_bytes[] = {
            0xff,0xff,0xff,0xff,0xff,0xff,0x07,0x00,0x07,0x80,0x07,0x80,0x07,0x80,0xf7,
            0xff };
...
const character_t characters[] = {
    ...
    {  .width = 16,  .height = 8,  .bytes = test_bytes },  // [13] = test
}; // const character_t characters[]
...
character_t character(char c) {
    ...
    if(c==' ') return characters[12];
    if(c=='test') return characters[13];
